	...
	$.ajax({
		...
		success: function(response){
					...
					for(i=0;i<8;i++){
						...
						//alert(todo[1]);
						navegacion="<button name=\"previous\" type=\"button\" class=\"btn btn-danger\" id=\"finalfinal\" onclick=\"botones();\">Home</button>";
						navegacion+="<button name=\"next\" type=\"button\" class=\"btn btn-danger\" id=\"prev\" onclick=\"numRep();\" style=\"float: right\">Anterior</button>";
